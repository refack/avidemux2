...
MACRO(ADM_MAIN_APP)
  ...
  IF(CROSS)
    TARGET_LINK_LIBRARIES(avidemux3_${QT_EXTENSION} PRIVATE ADM_UI_${QT_LIBRARY_EXTENSION}6)
    TARGET_LINK_LIBRARIES(avidemux3_${QT_EXTENSION} PRIVATE ADM_render6)
    TARGET_LINK_LIBRARIES(avidemux3_${QT_EXTENSION} PRIVATE ADM_coreUtils6)
    TARGET_LINK_LIBRARIES(avidemux3_${QT_EXTENSION} PRIVATE ADM_core6)
  ENDIF()
ENDMACRO()
#
MACRO(ADM_POSTBUILD)
