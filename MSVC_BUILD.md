...
2.  **Install Dependencies:**
    ...
    ```cmd
    vcpkg install qtbase:x64-windows ffmpeg:x64-windows libxml2:x64-windows pthreads:x64-windows ...
    ```
...
### PThreads4W Dependency
If CMake complains about `FIND_PACKAGE(PThreads4W REQUIRED)`, you need to install the `pthreads` package via vcpkg.
